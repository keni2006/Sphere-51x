...
bool CWorldStorageMySQL::Connect( const CServerMySQLConfig & config )
{
        ...
        for ( int iAttempt = 0; iAttempt < iAttempts; ++iAttempt )
	{
                ...
                std::vector<const char *> handshakeCandidates;
                std::vector<std::string> handshakeStorage;
                std::unordered_set<std::string> handshakeSeen;
                handshakeCandidates.push_back( NULL );
                ...
                auto addHandshakeCandidate = [&]( const std::string & sCandidate )
                {
                        ...
                        {
                                handshakeStorage.push_back( sNormalized );
                                handshakeCandidates.push_back( handshakeStorage.back().c_str() );
                        }
                };
                ...
                {
                        const char * pszHandshakeCharset = handshakeCandidates[iCandidate];
                        ...
                        {
                                const char * pszRetryCharset = handshakeCandidates[iCandidate + 1];
